...
void TimerLogic::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->timerTick((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TimerLogic::*)(int )>(_a, &TimerLogic::timerTick, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (TimerLogic::*)()>(_a, &TimerLogic::timerFinished, 1))
            return;
    }
}
...
// SIGNAL 0
void TimerLogic::timerTick(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void TimerLogic::timerFinished()
{
